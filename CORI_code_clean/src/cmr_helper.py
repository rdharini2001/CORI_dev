...
from cori_pipeline_utils_v13 import safe_name

# ============================================================
# H4 CMR preprocessing: raw-unit + standardized analysis columns
# ============================================================


# 3) Clinically motivated CMR feature families.
# Each family has include regex patterns and optional exclude patterns.
# The goal is not to analyze random numeric columns, but interpretable CMR phenotype domains:
# LV/RV structure-function, atrial morphology, aortic geometry, aortic stiffness,
# blood-pressure/arterial waveform traits, flow traits, myocardial tissue/strain where available.
